...
30. **Получение проекта по имени** (позитивный)
    - Название класса: `TestTaskManager`
...
31. **Добавление задачи в проект через менеджер задач** (позитивный)
    - Название класса: `TestTaskManager`
...
32. **Удаление задачи из проекта через менеджер задач** (позитивный)
    - Название класса: `TestTaskManager`
